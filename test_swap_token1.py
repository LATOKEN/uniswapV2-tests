...
if __name__ == '__main__':
    ...
    expectedOutputAmount = 453305446940074565
    ...
    print(reserves[0] == token0Amount - expectedOutputAmount)
    print(reserves[1] == token1Amount + swapAmount)
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, addressUniswapV2Pair) == token0Amount - expectedOutputAmount)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, addressUniswapV2Pair) == token1Amount + swapAmount)
    ...
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, feed_wallet.address) == totalSupplyToken0 - token0Amount + expectedOutputAmount)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, feed_wallet.address) == totalSupplyToken1 - token1Amount - swapAmount)
