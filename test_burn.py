...
if __name__ == '__main__':
    ...
    # Test
    token0Amount = 3000000000000000000
    token1Amount = 3000000000000000000
    MINIMUM_LIQUIDITY = 1000
    expectedLiquidity = 3000000000000000000
    ...
    # Check
    print(feed_wallet.balanceOf(addressUniswapV2Pair, abiUniswapV2Pair, feed_wallet.address) == 0)
    print(feed_wallet.totalSupply(addressUniswapV2Pair, abiUniswapV2Pair) == MINIMUM_LIQUIDITY)
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, addressUniswapV2Pair) == 1000)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, addressUniswapV2Pair) == 1000)
    ...
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, feed_wallet.address) == totalSupplyToken0 - 1000)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, feed_wallet.address) == totalSupplyToken1 - 1000)
