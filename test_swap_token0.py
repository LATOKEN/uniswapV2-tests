...
if __name__ == '__main__':
    ...
    # Test
    token0Amount = 5000000000000000000
    token1Amount = 10000000000000000000
    swapAmount = 1000000000000000000
    expectedOutputAmount = 1662497915624478906
    ...
    resultMintLRC20_1 = feed_wallet.mint(addressLRC20_1, abiLRC20_1, addressUniswapV2Pair, swapAmount)
    feed_wallet.update_nonce()
    print("MintLRC20_1: " + str(resultMintLRC20_1))

    resultSwap = feed_wallet.swapPair(addressUniswapV2Pair, abiUniswapV2Pair, 0, expectedOutputAmount, feed_wallet.address, '0x')
    feed_wallet.update_nonce()
    print("Swap: " + str(resultSwap))

    # Check
    reserves = feed_wallet.getReserves(addressUniswapV2Pair, abiUniswapV2Pair)
    print(reserves[0] == token0Amount + swapAmount)
    print(reserves[1] == token1Amount - expectedOutputAmount)
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, addressUniswapV2Pair) == token0Amount + swapAmount)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, addressUniswapV2Pair) == token1Amount - expectedOutputAmount)
    totalSupplyToken0 = feed_wallet.totalSupply(addressLRC20_1, abiLRC20_1)
    totalSupplyToken1 = feed_wallet.totalSupply(addressLRC20_2, abiLRC20_2)
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, feed_wallet.address) == totalSupplyToken0 - token0Amount - swapAmount)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, feed_wallet.address) == totalSupplyToken1 - token1Amount + expectedOutputAmount)
