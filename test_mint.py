...
if __name__ == '__main__':
    ...
    expectedLiquidity = 2000000000000000000
    ...
    # Check
    print(feed_wallet.totalSupply(addressUniswapV2Pair, abiUniswapV2Pair) == expectedLiquidity)
    print(feed_wallet.balanceOf(addressUniswapV2Pair, abiUniswapV2Pair, feed_wallet.address) == expectedLiquidity - MINIMUM_LIQUIDITY)
    print(feed_wallet.balanceOf(addressLRC20_1, abiLRC20_1, addressUniswapV2Pair) == token0Amount)
    print(feed_wallet.balanceOf(addressLRC20_2, abiLRC20_2, addressUniswapV2Pair) == token1Amount)
    reserves = feed_wallet.getReserves(addressUniswapV2Pair, abiUniswapV2Pair)
    print(reserves[0] == token0Amount)
    print(reserves[1] == token1Amount)
